...
export default function AdminDashboard() {
  const [activeTab, setActiveTab] = useState<"overview" | "products" | "reports">("overview");
  ...
  return (
    <div className="max-w-7xl mx-auto mt-8 px-4 pb-20">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        ...
        {/* Tombol Navigasi Tab */}
        <div className="flex bg-stone-100 p-1 rounded-lg print:hidden">
          <button
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-all ${activeTab === "products"
              ? "bg-white text-stone-900 shadow-sm"
              : "text-stone-500 hover:text-stone-900"
              }`}
          >
